...
vim.keymap.set("n", "<leader>gd", "<CMD>DiffviewFileHistory --follow %<CR>", { desc = "File history" })
vim.keymap.set({ "v", "x" }, "<leader>gd", "<ESC><CMD>'<,'>DiffviewFileHistory --follow<CR>", { desc = "File history" })
vim.keymap.set("n", "<leader>gv", diffview_toggle, { desc = "Toggle diffview" })
vim.keymap.set("n", "<leader>gp", "<CMD>ClipboardDiff<CR>", { desc = "Clipboard diff" })
vim.keymap.set({ "v", "x" }, "<leader>gp", "<ESC><CMD>ClipboardDiffSelection<CR>", { desc = "Clipboard diff" })
